...
const Sidebar = () => {
  ...
  return (
    ...
    >
      {/* Logo Section */}
      <div className="flex items-center gap-3 px-6 h-16 border-b border-white/40">
        <img
        ...
        />
        <h1 className="text-lg font-bold bg-gradient-to-r from-sky-700 to-indigo-700 bg-clip-text text-transparent">
          PFM
        </h1>
      </div>
